...
public class DataMakingActivity extends NMapActivity implements NMapView.OnMapStateChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        activity_dbConnect = DataMakingActivity.this;
    ...
    private final NMapPOIdataOverlay.OnStateChangeListener onPOIdataStateChangeListener = new NMapPOIdataOverlay.OnStateChangeListener() {
        ...
        public void onCalloutClick(NMapPOIdataOverlay poiDataOverlay, NMapPOIitem item) {
            ...
            Intent intent;
            intent = new Intent(DataMakingActivity.this, MassDataActivity.class);
            ...
            if (itemOverlay instanceof NMapPOIdataOverlay) {
                ...
                if (!poiDataOverlay.isFocusedBySelectItem()) {
                    ...
                    if (countOfOverlappedItems > 1) {
                        ...
                        Toast.makeText(DataMakingActivity.this, text, Toast.LENGTH_LONG).show();
                        return null;
                    }
                }
            }
    ...
    private final OnDataProviderListener onDataProviderListener = new OnDataProviderListener() {
        ...
        public void onReverseGeocoderResponse(NMapPlacemark placeMark, NMapError errInfo) {
            ...
            if (errInfo != null) {
                ...
                Toast.makeText(DataMakingActivity.this, errInfo.toString(), Toast.LENGTH_LONG).show();
                return;
            }
